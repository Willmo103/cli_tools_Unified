...
def json_to_dir(json_obj, path):
    ...
    if directories:
        ...
        selected_index = click.prompt("Enter the index of the directory to generate", type=int)
        ...
        json_file_path = click.prompt("Enter the path to a JSON file", type=click.Path(exists=True))
